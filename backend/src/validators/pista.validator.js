...
export const pistaValidator = [
  body("nombre")
    .trim()
    .notEmpty()
    .withMessage("El nombre de la pista es obligatorio")
    .isLength({ min: 3, max: 100 })
    .withMessage("El nombre debe tener entre 3 y 100 caracteres"),

  body("precioHora")
    .isFloat({ min: 0.5, max: 1000 })
    .withMessage("El precio debe estar entre €0.50 y €1000"),

  body("deporte")
    .trim()
    .isIn(["Pádel", "Tenis", "Fútbol", "Fútbol 5", "Baloncesto", "Voleibol"])
    .withMessage(
      "Deporte inválido. Opciones: Pádel, Tenis, Fútbol, Fútbol 5, Baloncesto, Voleibol",
    ),
  ...
  body("horariosDisponibles")
    .isArray({ min: 1 })
    .withMessage("Debe haber al menos un horario disponible"),
  ...
  body("iluminacion")
    .optional()
    .isBoolean()
    .withMessage("La iluminación debe ser verdadero o falso"),
